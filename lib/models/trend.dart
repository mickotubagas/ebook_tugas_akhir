...
List<Trend> trends = [
  ...
  Trend(
      ...
      hal: "417 Halaman",
      assets: "assets/pdf/Pulang Pergi.pdf"),
  Trend(
      image: "assets/images/buku4.jpg",
      title: "Bumi Manusia",
      creator: "Pramoedya Ananta Toer",
      rate: "4.5 ⭐",
      desk:
      ...
      hal: "535 Halaman",
      assets: "assets/pdf/Bumi Manusia.pdf"),
  Trend(
      ...
      rate: "4.3 ⭐",
      desk:
          "Teluk Alaska, bercerita tentang Anastasia Mhysa seorang gadis pendiam yang tidak memiliki kawan. Dirinya hanya hanya mampu bercerita pada buku diary berwarna pink yang selalu menemaninya kemanapun. /n Namun, tanpa seorang pun tahu sebenarnya gadis yang kerap dipanggil Ana ini juga memiliki sebuah buku diary berwarna hitam tempat dia menuliskan semua rahasianya. Di sekolah, Ana yang terus dirundung oleh Tasya dan Cindi pun akhirnya memiliki teman, Bulan. Kehadiran bulan juga membawa pengaruh baik bagi Ana dan membuat dirinya menjadi lebih ceria. /n Disisi lain Alister, memiliki geng yang seringkali merudung anak-anak lain termasuk Ana. Meskipun memiliki nama yang sama dengan teman kecilnya dulu, namun sifat Alister sekarang benar-benar berbeda dengan Alister yang ia kenal saat kecil. Inilah yang membuat Ana berpikir mungkin dia memang bukan orang yang sama. /n Ana yang terus di bully oleh geng Alister dan juga Tasya tetap sabar dan berusaha tenang, karena kini ada Bulan yang sering membantunya saat sedih. Tetapi, semua tentang Alister cukup mengusik Ana, membuatnya bertanya-tanya apakah Alister ini sama dengan Alister di masa kecilnya. Dari sini, Ana pun memutuskan untuk mencari tahu tentang Alister. /n Alister yang kasar, bahkan tidak segan-segan menyuruh orang-orang di kelas untuk tidak menjadi kawan Ana. Entah mengapa segala hal yang ada pada Ana selalu membuat dirinya kesal.  Suatu hari Alister mendapati bahwa dia melihat Ana di luar sekolah, kemudian Alister memutuskan untuk mengikutinya. /n Rupanya Ana berhenti di sebuah pemakaman umum, dan menangis di depan batu nisan sang ayah. Selama ini, tanpa dia sadari ternyata Ana selalu bercerita pada mendiang ayahnya atas segala kesulitan yang dihadapi di sekolah.",
      hal: "408 Halaman",
      assets: "assets/pdf/Teluk Alaska.pdf"),
];
